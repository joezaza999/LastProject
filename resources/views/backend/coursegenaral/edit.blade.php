...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10 col-md-offset-1">
            <div aligh="right">
                <a href="{{ route('bcoursegenaral') }}" class="btn btn-default">กลับ</a>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('bcoursegenaral.update' , $coursegenaral->id) }}" enctype="multipart/form-data">
