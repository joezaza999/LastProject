...
class LocationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('blocation')->with('success', 'เพิ่มข้อมูลสถานที่ฝึกประสบการณ์สำเร็จ');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('blocation')->with('success', 'แก้ไขข้อมูลสถานที่ฝึกประสบการณ์สำเร็จ');
    }
    ...
    public function destroy($id)
    {
        ...
        $locations->delete();
        return redirect('blocation')->with('success', 'ลบข้อมูลสถานที่ฝึกประสบการณ์สำเร็จ');
    }
}
